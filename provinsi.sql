...
-- Dumping structure for table harviacode.kecamatan
CREATE TABLE IF NOT EXISTS `kecamatan` (
  ...
  KEY `districts_id_index` (`id_kota_fk`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Dumping data for table harviacode.kecamatan: ~136 rows (approximately)
...
-- Dumping structure for table harviacode.kota
CREATE TABLE IF NOT EXISTS `kota` (
  `id_kota` int(4) NOT NULL,
  `id_provinsi_fk` int(2) NOT NULL,
  `nama_kota` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id_kota`),
  KEY `regencies_province_id_index` (`id_provinsi_fk`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Dumping data for table harviacode.kota: ~68 rows (approximately)
...
-- Dumping structure for table harviacode.provinsi
...
-- Dumping data for table harviacode.provinsi: ~34 rows (approximately)
